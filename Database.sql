...
CREATE TABLE USUARIO (ID INT NOT NULL AUTO_INCREMENT, NOME VARCHAR(64) NOT NULL, SOBRENOME VARCHAR(64) NOT NULL, TELEFONE VARCHAR(11) NOT NULL, LOGIN VARCHAR(64) NOT NULL, SENHA VARCHAR(64) NOT NULL, ADMIN BOOLEAN DEFAULT FALSE, DELETADO BOOLEAN DEFAULT FALSE, PRIMARY KEY (ID));

CREATE TABLE POSTAGEM (ID INT NOT NULL AUTO_INCREMENT,TITULO VARCHAR(64) NOT NULL, TEXTO LONGTEXT, AUTOR INT NOT NULL, DATA DATETIME DEFAULT CURRENT_TIMESTAMP, DELETADO BOOLEAN DEFAULT FALSE, PRIMARY KEY (ID), FOREIGN KEY (AUTOR) REFERENCES USUARIO(ID));
...
INSERT INTO USUARIO (NOME, SOBRENOME, TELEFONE, LOGIN, SENHA, ADMIN) VALUES ('ERINALDO', 'PEREIRA', '9999-9999', 'admin', 'admin', TRUE);

INSERT INTO USUARIO (NOME, SOBRENOME, TELEFONE, LOGIN, SENHA, ADMIN) VALUES ('ERINALDO', 'PEREIRA', '9999-9999', 'ERINALDO', 'PEREIRA');
...
INSERT INTO COMENTARIO (AUTOR, TEXTO, IDPOSTAGEM) VALUES (1, 'TESTE DE COMENTARIO, TESTE DE COMENTARIO, TESTE DE COMENTARIO, TESTE DE COMENTARIO', 1);
